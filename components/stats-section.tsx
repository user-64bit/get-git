    ...
    return (
      <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3 animate-pulse">
        {[...Array(5)].map((_, i) => (
          <Card
            key={i}
            className={`${i > 2 ? "col-span-full md:col-span-2" : ""} h-32`}
          >
    ...
    <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card className="overflow-hidden border border-primary/10 shadow-sm hover:shadow-md transition-all duration-300 animate-in fade-in-25 duration-700">
        ...
        <CardContent className="p-6">
          <div className="text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent animate-in slide-in-from-bottom-3 duration-500">
            {stats.totalPRs}
          </div>
        </CardContent>
      </Card>
      <Card className="overflow-hidden border border-purple-500/10 shadow-sm hover:shadow-md transition-all duration-300 animate-in fade-in-25 duration-700 delay-150">
        ...
        <CardContent className="p-6">
          <div className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent animate-in slide-in-from-bottom-3 duration-500 delay-150">
            {stats.mergedPRs}
          </div>
      ...
      <Card className="overflow-hidden border border-primary/10 shadow-sm hover:shadow-md transition-all duration-300 animate-in fade-in-25 duration-700 delay-300">
        ...
        <CardContent className="p-6">
          <div className="text-3xl font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent animate-in slide-in-from-bottom-3 duration-500 delay-300">
            {stats.totalReviews}
          </div>
        </CardContent>
      </Card>
